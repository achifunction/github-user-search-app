    ...
    return (
        <>
            <div style={{ height: "100px" }}>
                <div style={{ display: "flex", alignItems: "center", marginLeft: "24px", marginTop:"15px" }}>
                    ...
                    <H4>{data.location || "no location" }</H4>
                </div>
                <div style={{ display: "flex", alignItems: "center", marginLeft: "24px", marginTop:"15px" }}>
                ...
                <div style={{ display: "flex", alignItems: "center", marginLeft: "24px", marginTop:"15px" }}>
                    ...
                    <H4>{data.twitter_username || "not found"}</H4>
                </div>
                <div style={{ display: "flex", alignItems: "center", marginLeft: "24px", marginTop:"15px"}}>
